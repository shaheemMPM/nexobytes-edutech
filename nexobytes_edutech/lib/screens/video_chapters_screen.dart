...
import 'package:nexobytes_edutech/screens/video_lectures_screen.dart';
...
class VideoChapterScreen extends StatefulWidget {
  ...
  const VideoChapterScreen({
    this.subjectId, this.subjectName
  });

  @override
  _VideoChapterScreenState createState() => _VideoChapterScreenState();
}
            ...
            Padding(
              ...
              child: ClipPath(
                ...
                child: Container(
                  ...
                  child: Text(
                    "VIDEOS / "+widget.subjectName.toUpperCase(),
                    style: TextStyle(
