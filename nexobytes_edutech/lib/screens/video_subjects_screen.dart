...
import 'package:nexobytes_edutech/screens/video_chapters_screen.dart';
import 'package:http/http.dart' as http;

class VideoSubjectScreen extends StatefulWidget {
  final classId, className;

  VideoSubjectScreen({this.classId, this.className});

  @override
  _VideoSubjectScreenState createState() => _VideoSubjectScreenState();
}
            ...
            Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Hero(
                      tag: "video_class",
                      child: Text("Video Class", style: kHeadingextStyle)),
                  SizedBox(height: 16),
                  Row(
                    children: <Widget>[
